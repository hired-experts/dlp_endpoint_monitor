...
[JsonDiscriminant(EventType.UsbProtectionStatus)]
public record UsbProtectionStatusEvent(string? Id, bool Ok, ProtectionMode Mode, string? Error = null) : IEvent
{
...
{
    public EventType Type => EventType.UsbWhitelistGet;
}

[JsonDiscriminant(EventType.UsbBlacklistGet)]
public record UsbBlacklistGetEvent(string? Id, bool Ok, bool Enabled, IEnumerable<WhitelistEntryDto> Entries) : IEvent
{
    public EventType Type => EventType.UsbBlacklistGet;
}
#endregion
